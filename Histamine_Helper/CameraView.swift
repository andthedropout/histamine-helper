...
struct CameraView: View {
    ...
    var body: some View {
        ZStack (alignment: .topLeading) {
            ...
            VStack {
                if let captureSession = captureSession, let photoOutput = photoOutput {
                    CameraPreviewView(captureSession: captureSession, photoOutput: photoOutput, photoCaptureDelegate: photoCaptureDelegate, isUsingFrontCamera: $isUsingFrontCamera)
            ...
            if isProcessing {
                ...
                HStack {
                    ...
                    .padding(.leading, 40)  // Doubled left padding
                    ...
                    .foregroundColor(.white)
                    .padding(.trailing, 40)  // Doubled right padding
                }
                .padding(.top, (UIApplication.shared.windows.first?.safeAreaInsets.top ?? 0) + 20) // Increased top padding
        ...
        .sheet(isPresented: $showLandingView) {
            LandingView(showLanding: $showLandingView)
        }
    }
